...
<div class="container-fluid p-0">
    <div class="row m-0">
                                    ...
                                    <div class="collapse" id="productcollapse">
                                        <div class="collapse-div">
                                            <ul class="collapse-div-items text-light">
                                                <li><a class="collapse-div-item" href="${BASE_URL}admin/category-setup-product" id="productCategory">Product Category Setup</a></li>
                                                <li><a class="collapse-div-item" href="${BASE_URL}admin/view-product" id="productDetails">Product Details</a></li>
                                                <li><a class="collapse-div-item" href="${BASE_URL}admin/add-product" id="productAdd">Product Add</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
        ...
        <%-- Dashboard Body Part Start --%>
        <layout:block name="contents"></layout:block>
        <%-- Dashboard Body Part End --%>
    </div>
</div>
