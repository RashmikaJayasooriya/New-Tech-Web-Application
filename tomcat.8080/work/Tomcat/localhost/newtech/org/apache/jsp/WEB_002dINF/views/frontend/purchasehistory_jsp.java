 ...
 * Generated at: 2023-09-10 18:10:01 UTC
...
public final class purchasehistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_layout_005fextends_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/purchasehistory.jsp(6,0) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/purchasehistory.jsp(7,4) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/purchasehistory.jsp(43,36) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("myList");
      // /WEB-INF/views/frontend/purchasehistory.jsp(43,36) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/frontend/purchasehistory.jsp(43,36) 'camera(0),console(0),laptop(0),mobile(0),drone(0),smartHome(0)'",_jsp_getExpressionFactory().createValueExpression("camera(0),console(0),laptop(0),mobile(0),drone(0),smartHome(0)",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/purchasehistory.jsp(46,36) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/frontend/purchasehistory.jsp(46,36) '${myList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${myList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/frontend/purchasehistory.jsp(46,36) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("                                        <tr>\r\n");
            out.write("                                            <td scope=\"row\"><span><?php echo $i + 1; ?></span></td>\r\n");
            out.write("                                            <td scope=\"row\"><span>18eca633987a</span></td>\r\n");
            ...
            out.write(".jpeg\" class=\"img-fluid\" width=\"100\" height=\"10\">\r\n");
            out.write("                                            </td>\r\n");
            out.write("                                            <td>\r\n");
            out.write("                                                <ol>\r\n");
            out.write("                                                    <li>Product Name:- Huawei P30 Pro p30 p30 lite</li>\r\n");
            out.write("                                                    <li>Product Description:- Lorem, ipsum dolor sit amet consectetur\r\n");
            out.write("                                                        adipisicing elit. Veritatis, commodi.\r\n");
            out.write("                                                    </li>\r\n");
            out.write("                                                </ol>\r\n");
            out.write("                                            </td>\r\n");
            ...
            out.write("                                                        <div class=\"row-fluid\">\r\n");
            out.write("                                                            <div class=\"offset col d-grid\">\r\n");
            out.write("                                                                <button class=\"btn btn-sm btn-success rounded d-flex my-1 \"\r\n");
            out.write("                                                                        onclick=\"addfeedback();\"><i\r\n");
            out.write("                                                                        class=\"bi bi-info-circle-fill\"></i> &nbsp;Feedback\r\n");
            out.write("                                                                </button>\r\n");
            out.write("                                                            </div>\r\n");
            out.write("                                                            <div class=\"offset col d-grid\">\r\n");
            out.write("                                                                <button class=\"btn btn-sm btn-danger rounded d-flex my-1 \"\r\n");
            out.write("                                                                        onclick=\"deletefrompurchasehistory();\"><i\r\n");
            out.write("                                                                        class=\"bi bi-trash-fill\"></i> &nbsp;Delete\r\n");
            out.write("                                                                </button>\r\n");
            out.write("                                                            </div>\r\n");
            out.write("                                                        </div>\r\n");
            out.write("                                                    </div>\r\n");
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("                                    <li class=\"breadcrumb-item active\" aria-current=\"page\">Purchased History</li>\r\n");
      out.write("                                </ol>\r\n");
      out.write("                            </nav>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"col-12 text-center mb-3\">\r\n");
      out.write("                            <span class=\"fw-bold fs-3\">Transaction Hist<i class=\"bi bi-clock-history\"></i>ry</span>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"col-12\">\r\n");
      out.write("                            <div class=\"table-responsive px-5 mt-3 scrollbar\">\r\n");
      out.write("                                <table class=\"table table-striped table-hover table-light table-bordered\">\r\n");
      out.write("                                    <thead>\r\n");
      out.write("                                    <tr>\r\n");
      out.write("                                        <th scope=\"col\" class=\"text-nowrap\">#</th>\r\n");
      out.write("                                        <th scope=\"col\" class=\"text-nowrap\">Invoice Number</th>\r\n");
      out.write("                                        <th scope=\"col\" class=\"text-nowrap\">Item Image</th>\r\n");
      ...
      out.write("                        <div class=\"col-12 d-flex justify-content-center mt-2 mb-4\">\r\n");
      out.write("                            <nav>\r\n");
      ...
      out.write("                                    </li>\r\n");
      out.write("                                    <li class=\"page-item shadow-none\"><a class=\"page-link shadow-none\" href=\"#\">3</a>\r\n");
      out.write("                                    </li>\r\n");
      out.write("                                    <li class=\"page-item\">\r\n");
